 ...
 * @since  1.6
 */
class Act_buildingRulesLegacy implements RulesInterface
{
    /**
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = Act_buildingHelpersAct_building::getModel($vars['view']);
