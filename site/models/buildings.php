...
/**
 * Methods supporting a list of Act_building records.
 *
 * @since  1.6
 */
class Act_buildingModelBuildings extends \Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_act_building'))
		{
		...
		else
		{
            ...
            if (!empty($search))
            {
                ...
                else
                {
					...
					$query->where('( a.building LIKE ' . $search . ' )');
                }
            }
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_ACT_BUILDING_SEARCH_FILTER_DATE_FORMAT"), "warning");
